...
define(function (require) {
    ...
    module.loadHqData = function loadHqData() {
        common.jsonP('http://nufm.dfcfw.com/EM_Finance2014NumericApplication/JS.aspx?type=CT&cmd=' + stockid + '&sty=MPICT&st=z&sr=&p=&ps=&cb=?&js=([[(x)]])&token=7bc05d0d4c3c22ef9fca8c2a912d779c', function (json) {
            if (json && json[0]) {
    ...
    module.intital = function (stockcode) {
        stockid = stockcode;
        module.loadHqData();
        var hqpic = 'http://pifm3.eastmoney.com/EM_Finance2014PictureInterface/Index.aspx?id=';
        hqpic = hqpic + stockid;
